...
<div class="container mt-4">
  <div class="form-container">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1 style="font-size:23px; font-weight:bolder;">Add Subcategory</h1>
  ...
  @endforeach
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" name="slug" value="{{ old('slug') }}" placeholder="auto generate if empty">
        </div>
