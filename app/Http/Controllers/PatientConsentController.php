...
// $consent = PatientConsent::create($validated);

// if (!empty($consent->email_address)) {
//     Mail::to($consent->email_address)->send(new ConsentSubmitted($consent));
// }
...
public function store(Request $request)
{
    $validated = $request->validate([
        ...
        'consent_to_assessment'               => 'accepted',
        'understanding_of_benefits_and_risks' => 'accepted',
        'medical_history_disclosure'          => 'accepted',
        'home_virtual_session_responsibility' => 'accepted',
        'tele_rehabilitation_consent'         => 'accepted',
        'data_privacy'                        => 'accepted',
        'payment_policy_acknowledgment'       => 'accepted',
        'voluntary_participation'             => 'accepted',
        'liability_waiver'                    => 'accepted',
        'guardian_consent'                    => 'nullable|boolean',
        'final_agreement_statement'           => 'accepted',
