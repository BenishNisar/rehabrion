...
<head>
	...
	<!-- FAVICONS ICON -->
<link rel="shortcut icon" type="image/png" href="{{ asset('Dashboard_assets/images/favicon.png') }}">
...
<link href="{{ asset('Dashboard_assets/vendor/bootstrap-datepicker-master/css/bootstrap-datepicker.min.css') }}" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="email-inbox.html" class="dropdown-item ai-icon">
                                     ...
                                     <a href="page-login.html" class="dropdown-item ai-icon">
                                        <svg id="icon-logout1" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
            ...
            <div class="dlabnav-scroll">
				<div class="dropdown header-profile2 ">
					<a class="nav-link " href="javascript:void(0);"  role="button" data-bs-toggle="dropdown">
                        ...
                        <div class="header-info2 d-flex align-items-center">
    <img src="{{ auth()->user()->profile_img ? asset(auth()->user()->profile_img) : asset('images/profile/pic1.jpg') }}" alt="">
    ...
    <div class="d-flex align-items-center sidebar-info">
        <div>
            ...
            <small class="text-end font-w400">
                {{ auth()->user()->role_id == 1 ? 'Superadmin' : 'User' }}
            </small>
        </div>
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{ route('Dashboard.admin.jobs.index') }}">Jobs</a></li>
							<li><a href="{{ route('Dashboard.admin.jobs.application') }}">Application</a></li>
							<li><a href="{{ route('Dashboard.admin.jobs.index') }}">Profile</a></li>
							<li><a href="{{ route('Dashboard.admin.jobs.index') }}">Statistics</a></li>
							<li><a href="{{ route('Dashboard.admin.jobs.index') }}">Companies</a></li>
						</ul>
					...
					<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('Dashboard.admin.jobs.list') }}">Job Lists</a></li>
                            {{-- <li><a href="{{ route('Dashboard.admin.jobs.view', $job->id) }}">Job View</a></li> --}}
                            <li><a href="{{ route('Dashboard.admin.jobs.application') }}">Job Application</a></li>
                            <li><a href="{{ route('Dashboard.admin.jobs.apply') }}">Apply Job</a></li>
                            <li><a href="{{ route('Dashboard.admin.jobs.new-job') }}">New Job</a></li>
                            <li><a href="{{ route('Dashboard.admin.jobs.user_profile') }}">User Profile</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						<i class="flaticon-381-user-7"></i>
							<span class="nav-text">Profile</span>
						<span class="badge badge-xs style-1 new-badge">New</span>
					</a>
					<ul aria-expanded="false">
						 <li><a href="{{ route('Dashboard.admin.users.index') }}">Overview</a></li> <!-- List all users -->
    <li><a href="{{ route('Dashboard.admin.users.add') }}">Add New User</a></li> <!-- Add a new user -->
    {{-- <li><a href="{{ route('Dashboard.admin.users.edit', $item->id) }}">Edit User</a></li> <!-- Edit an existing user (if needed) --> --}}
    <li><a href="account/settings.html">Settings</a></li> <!-- You may keep this for user profile settings -->
    <li><a href="account/activity.html">User Activity</a></li> <!-- Tracking user activity (optional) -->
    <li><a href="account/security.html">Security</a></li> <!-- Security settings for users -->
    <li><a href="account/roles.html">User Roles</a></li> <!-- Link to manage user roles -->
    <li><a href="account/logs.html">Activity Logs</a></li> <!-- Logs for user actions -->
					</ul>
					</li>
					{{-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
					...
					<ul aria-expanded="false">
						<li><a href="{{ route('Dashboard.admin.users.index') }}">Overview</a></li>
				...
				{{-- <div class="plus-box">
					<p class="fs-14 font-w600 mb-2">Job Portal<br>Your Resume Easily<br></p>
					<p class="plus-box-p">Lorem ipsum dolor sit amet</p>
				</div>
				<div class="copyright">
					<p><strong>Job Portal</strong> © <span class="current-year">2024</span> All Rights Reserved</p>
    ...
    <p class="plus-box-p">
        Discover opportunities, connect with top companies, and build your professional future with ease.
    </p>
</div>

<div class="copyright">
    <p><strong>JobPortalPro</strong> © <span class="current-year">2024</span> All Rights Reserved</p>
    <p class="fs-12">
...
<script src="{{ asset('Dashboard_assets/vendor/bootstrap-datepicker-master/js/bootstrap-datepicker.min.js') }}"></script>
...
<script src="{{ asset('Dashboard_assets/js/dlabnav-init.js') }}"></script>
<script src="{{ asset('Dashboard_assets/js/dashboard/profile.js') }}"></script>
<script src="{{ asset('Dashboard_assets/js/styleSwitcher.js') }}"></script>
